    ...
    public class SipaaKrnl : Kernel
    {
        ...
        private void BootOperatingSystem()
        {
            ...
            else
            {
                ...
                LoginCredentialsReader reader = new LoginCredentialsReader();
                this.WriteLine("Username : " + reader.getUsername(), "LoginCredentialsReader");
                this.WriteLine("Password : " + reader.getPassword(), "LoginCredentialsReader");
                Console.WriteLine("Password : " + reader.getUsername());
                desktop = new SipaaSODE.Desktop(SipaaSODE.UI.Theme.Dark, this, reader.getUsername(), reader.getPassword());
